...
<div class="scrollbar">
    ...
    <div class="continUp">
        ...
        <div class="frmUp">
            <form action="" method="post" enctype="multipart/form-data" id="formUpload">
                ...
                <progress id="progressBar2" value="0" max="100" class="progressBar"></progress>
    ...
    <div class="continUp">
        ...
        <div class="frmUp">
            <form action="" method="post" enctype="multipart/form-data" id="formUpload">
                <div class="container__file">
                    <input type="text" name="" id="" placeholder="Buscar archivo" readonly class="file__txt">
                    <label for="" class="form__file-btn">&#128193; Examinar</label>
                    <input type="file" name="" id="" accept=".json" class="form__file" required>
                </div>
                <progress id="progressBar3" value="0" max="100" class="progressBar"></progress>
    ...
    <div class="continUp">
        ...
        <div class="frmUp">
            <form action="" method="post" enctype="multipart/form-data" id="formUpload">
                ...
                <progress id="progressBar4" value="0" max="100" class="progressBar"></progress>
                <input type="submit" value="Guardar" class="btn" name="" id="">
            </form>
        </div>
    </div>
    ...
    <div class="continUp">
        ...
        <div class="frmUp">
            <form action="" method="post" enctype="multipart/form-data" id="formUpload">
                ...
                <progress id="progressBar5" value="0" max="100" class="progressBar"></progress>
                <input type="submit" value="Guardar" class="btn" name="" id="">
            </form>
        </div>
    </div>
    ...
    <div class="continUp">
        ...
        <div class="frmUp">
            <form action="" method="post" enctype="multipart/form-data" id="formUpload">
                ...
                <progress id="progressBar6" value="0" max="100" class="progressBar"></progress>
                <input type="submit" value="Guardar" class="btn" name="" id="">
            </form>
        </div>
    </div>
    ...
    <div class="continUp">
        ...
        <div class="frmUp">
            <form action="" method="post" enctype="multipart/form-data" id="formUpload">
                ...
                <progress id="progressBar7" value="0" max="100" class="progressBar"></progress>
                <input type="submit" value="Guardar" class="btn" name="" id="">
            </form>
        </div>
    </div>
