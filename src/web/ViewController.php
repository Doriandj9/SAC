...
class ViewController implements \frame\WebRoutes
{
    ...
    {
        $this->profesorTable = new \models\DataBaseTable(
        ...
        $this->responsabilidadTable = new \models\DataBaseTable(
            new \models\conection\Conection(),
            'responsabilidad',
            'cod_responsabilidad'
        );
        $this->evidencesTable = new \models\DataBaseTable(
            new \models\conection\Conection(),
            'evidencia',
            'cod_evidencia'
        );
        $this->passwordUpdate = new \models\DataBaseTable(
            new \models\conection\Conection(),
            'profesor',
            'password_profesor'
        );
    ...
    public function getRoutes(): array
    {
        ...
        // Controlador para el coordinador
        $coordinatorController = new \controllers\Coordinator(
            $this->evidencesTable,
            $this->profesorTable,
            $this->responsabilidadTable,
            $this->profesor_responsabilidad,
        ...
        return [
            ...
            'coordinator/upload/information' => [
                'GET' => [
                ...
                'login' => true,
                'responsability' => \web\Responsability::COORDINADOR
            ],
